...
void codigo(struct Produto * a, int N);
void valor(struct Produto * a, int N);
void alimentar(struct Produto* a, int N);
void mostrar(struct Produto* a, int N);
